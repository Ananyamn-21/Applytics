...
let JobApplicationsController = class JobApplicationsController {
    ...
    findAll(userId, page, limit) {
        return this.jobApplicationsService.findAllByUser(userId, page ? parseInt(page, 10) : 1, limit ? parseInt(limit, 10) : 20);
    }
    getStats(userId) {
    ...
    async downloadResume(userId, applicationId, res) {
        const application = await this.jobApplicationsService.findById(userId, applicationId);
        if (!application.tailoredResumeUrl ||
            !fs.existsSync(application.tailoredResumeUrl)) {
            throw new common_1.NotFoundException('Resume file not found for this application');
        }
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], JobApplicationsController.prototype, "getStats", null);
__decorate([
    (0, common_1.Get)(':id'),
    __param(0, (0, current_user_decorator_js_1.CurrentUser)('id')),
...
], JobApplicationsController.prototype, "downloadResume", null);
exports.JobApplicationsController = JobApplicationsController = __decorate([
    (0, common_1.Controller)('applications'),
    (0, common_1.UseGuards)(jwt_auth_guard_js_1.JwtAuthGuard),
    __metadata("design:paramtypes", [job_applications_service_js_1.JobApplicationsService])
